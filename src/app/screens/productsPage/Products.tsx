...
export default function Products() {
  ...
  const searchOrderHandler = (p0: string) => {
    productSearch.search = searchText;
    setProductSearch({...productSearch});
  };

  const searchProductHandler = () => {
    productSearch.order = searchText;
    setProductSearch({...productSearch});
  };
          ...
          <Stack className={"avatar-big-box"}>
            <Stack className={"avatar-static-box"}>
              ...
              <Box className={"search-box"}>
                ...
                />
                <Button className={"search-button"} endIcon={<SearchIcon />} onClick={searchProductHandler}>Search</Button>
              </Box>
            </Stack>
          </Stack>
          ...
          <Stack className={"list-category-section"}>
            <Stack className={"product-category"}>
              <div className={"category-main"}>
                ...
                onClick={() => searchCollectionHandler(ProductCollection.DESSERT)}>Dessert</Button>
                ...
                <Button variant={"contained"} color={ productSearch.productCollection === ProductCollection.SALAD ? "primary" : "secondary"} onClick={() => searchCollectionHandler(ProductCollection.SALAD)}>Salad</Button>
